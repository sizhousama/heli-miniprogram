...
var a, e, i = getApp(), s = i.requirejs("core"), o = i.requirejs("wxParse/wxParse"), n = i.requirejs("biz/diypage"), r = i.requirejs("biz/diyform"), d = i.requirejs("biz/goodspicker"), c = (i.requirejs("foxui"), 
i.requirejs("jquery"));
...
Page((e = {
    ...
    onLoad: function(t) {
        i.globalDataClose.flag && wx.navigateBack({
            delta: 1
        }), t = t || {};
        var a = this;
  ...
  navto: function (e) {
    ...
    var a = this, e = parseInt(t.status), s = t.starttime, o = t.endtime;
    if (-1 != e) {
