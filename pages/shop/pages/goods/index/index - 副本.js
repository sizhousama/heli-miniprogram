  ...
  navto: function (e) {
      ...
      wx.getLocation({
        ...
        success: function (res) {
          ...
          var accuracy = res.accuracy; // 位置精度
              wx.request({
                url: 'https://shop.weiyuliang.com/tp/public/index.php/api/auth/get_location',
                data: {
                  latitude: latitude,
                  longitude: longitude
                },
    ...
    getList: function() {
        ...
        t.setData({
            ...
            t.data.params.city = t.data.city, e.get("goods/get_list", t.data.params, function(e) {
            console.log(e);
            var a = {
                loading: !1,
                count: e.total,
