...
sco.data.YS_listb.done = function(re,sco){
  sco.setData({'remind':re.remind});
    ...
    //    6、接口6：设置施工进度时间；
    sco.data.YS_objb.url = 'api/appauth/set_sgriqi';
    sco.data.YS_objb.done = function(re,sco){
        YSfac.msg(re);
        // wx.showToast({
        //   title: '设置成功',
...
if(re.code>0){
  sco.setData({'tapshow':0});
    ...
    re.data.unshift({worktype:0,noticetype:0,city_id:0,province_id:0,name:'最新',myclass:str,id:0});
...
//  console.log(re);
    ...
    sco.data.YS_objc.before = function(sco){
     sco.data.YS_objc.params = {codeid:prcodeid,isapp:1};
    }
    sco.data.YS_objc.done = function(re,sco){
